<template>
    <div>
        ...
        <a-button
            ...
            >add new classroom</a-button
        >
        <br />
        count:{{ Ap.res?.my_classes?.["c_classes"]?.length }}
        <div class="rounded overflow-x-auto w-full m-auto">
            <table cellspacing="0" class="tg w-full">
                ...
                <tbody>
                    <tr
                        v-for="(item, index) in Ap.res?.my_classes?.[
                            'c_classes'
                        ]"
                        :key="index"
                        :class="{
                        ...
                        <td>
                            <a-tooltip color="purple">
                                ...
                                <a-button
                                    ...
                                    class=" "
                                    @click="
                                        show_edit_subjects(item, item['detail'])
                                    "
                                >
                                    subjects count:
            ...
            >
                ...
                <c_class_join_class_subject_teacher
                    ...
                    :classroom="classroom"
                    :my_teachers="Ap.res?.my_classes?.hrschooluser"
                    :subjects="Ap.res?.my_classes?.c_subjects"
                    >c_class_join_class_subject_teacher
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <a-select-option
                                v-for="grade in Ap.res?.my_classes?.[
                                    'c_grades'
                                ]"
                                :value="grade.id"
...
import c_class_insert from "@/pages/hr/school_admin/school_setup/classroom/co/c_class_insert.vue";
import c_class_join_class_subject_teacher from "@/pages/hr/school_admin/school_setup/classroom/co/c_class_join_class_subject_teacher.vue";
...
const school_id = ref(Ap.res?.my_classes?.["c_classes"][0]["school_id"]);
...
const show_edit_subjects = (item, my_classroom) => {
...
const change_sequence_fun = () => {
    ...
    var counter = 1;
    Ap.res?.my_classes?.["c_classes"].forEach((element, key) => {
...
const move_here = (index) => {
    // up_sequence.value=Ap.res?.my_classes?.['c_classes'][index]['sequence']

    var new_sequence = Ap.res?.my_classes?.["c_classes"]?.[index]?.["sequence"];
    //   var old_sequence=Ap.res?.my_classes?.['c_classes']?.[first_place1.value]?.['sequence']
