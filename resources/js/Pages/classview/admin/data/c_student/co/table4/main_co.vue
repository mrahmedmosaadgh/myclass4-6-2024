<template>
    <div>
        <div class="w-full flex justify-center pt-4">
            <!-- <div
                class="absolute top-0 w-full gap-2 px-4 noprint red pointer-events-none"
            ></div> -->
            <!-- @save_create="fun_create($event)" @save_update="fun_update($event)" -->
            <div>

            <!-- {{  settings['can_new'] }} -->
                <div class="px-12 pointer-events-auto flex gap-4">
                    <a-button
                        v-if="my_mood1.my_mood == 'view' && settings['can_new']"
                        class="px-1"
                        type="primary"
            ...
            <form_update
                class="sm:w-full lg:w-1/2 lg:px-12"
