<template>
    <div>
        ...
        <a-input v-model:value.lazy="props.data.en" placeholder="name  " />
        <div class="p-1">name_ar</div>
        <a-input
            v-model:value.lazy="props.data.ar"
            placeholder="name_ar"
        />
        ...
        <div class="flex flex-row gap-2">
            ...
            <div class="p-0">
                ...
                <input
                    class="ant-input"
                    type="date"
                    :min="props.data.start"
                    v-model="props.data.end"
                />
            </div>
        ...
        <div class="p-2">
            <a-button
                ...
                @click="
                    fetch_first({
                        fun: 'admin_control_add_semester_calendar',
            ...
            <a-button
                ...
                @click="
                    fetch_first({
                        fun: 'admin_control_delete_extra_dates_from_attendance',
                        route: '/api/school_admin/add_school_semester/create',
                        data: props.data,
                        create_calendar_data: create_calendar_data,
                    })
            ...
            <a-button type="text" @click="$emit('open', false)"
                >cancel</a-button
            >
        </div>
