...
<sync-outlined spin />
    ...
    <loading-outlined />
            ...
            <a-button
                ...
                size="small"
                style="padding: 0px"
                class="noprint hover:opacity-100 opacity-40"
...
// import table_sort_icon from "./table_sort_icon.vue";
// const props=defineProps(['data','text','col' ])
const emit = defineEmits(["update", "delete", "view"]);
// function fun(){
//     //console.log(props.col);
//  emit('my_col',props.col)
// }open
