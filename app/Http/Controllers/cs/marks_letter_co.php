...
// Route::post('marks_letter', [c_marks_letter_co::class, 'marks_letter']);
// php artisan route:cache
// /api/school_admin/marks_letter
class marks_letter_co extends Controller
{
    public function marks_letter(Request $request)
    {
        $fun = $request['fun'];
        $my_id =  Auth::user()->id;
        $data = $request['data'];
        ...
        if ($fun == 'view_letter') {
            ...
            return response()->json(['msg' => 'Data view_letter successfully.', 'data' => $c_mark_grade_letter], 200);
        }
